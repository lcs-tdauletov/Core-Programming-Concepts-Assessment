...
let skiHillOpen = newSnowfallAmount > 10 || temperatureInCelsius < -5 && !isSnowMakingEquipmentBroken

if skiHillOpen {
    print("We're open and waiting for you.")
} else {
    print("We're closed; but you can still come out to have a breath of fresh air.")
}
/*:
